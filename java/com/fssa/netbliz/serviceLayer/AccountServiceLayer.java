...
public class AccountServiceLayer {   
	...
	public static boolean getAccountByNumber(String accountNumber) throws AccountValidatorExceptions, AccountDaoException {
	...
	public static boolean removeAccountByAccountNumber(String accountNumber) throws AccountValidatorExceptions, AccountDaoException {
	...
	public static boolean getAllActiveAccountNumber() throws AccountDaoException {
