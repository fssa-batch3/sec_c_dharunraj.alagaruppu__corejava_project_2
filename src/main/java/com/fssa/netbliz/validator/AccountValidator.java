...
public class AccountValidator {
     ...
     * @throws ValidatorException If the provided IFSC code is null, empty, or invalid.
     */
     ...
     * @throws ValidatorException If the provided phone number is null, empty, of incorrect length, or invalid.
     */
     ...
     * @throws ValidatorException If the provided account type is null, empty, not recognized, or invalid.
     */
     ...
     * @return {@code true} if the minimum balance is valid, {@code false} otherwise.
     * @throws ValidatorException If the provided minimum balance is outside the acceptable range.
     */
